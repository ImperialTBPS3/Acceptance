...
efficiency = [[] for i in range(len(legendre_bins) - 1)]
efficiency_indices = [[] for i in range(len(legendre_bins) - 1)]
...
efficiency_scaled = [[] for i in range(len(legendre_bins) - 1)]
for i in range(len(legendre_bins) - 1):
...
acceptance = [[] for i in range(len(legendre_bins) - 1)]
for i in range(len(legendre_bins) - 1):
